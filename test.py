...
async def main():
    ...
    try:
        ...
        agent_settings = AgentSettings(
            task="Visit https://bot.incolumitas.com/#botChallenge, Click on behavioralClassification, then click on solve the challenge below, then scroll a bit down and solve the challenge, then visit https://testrecaptcha.github.io/ and click the captcha box, wwait for 2 seconds, then visit https://antcpt.com/score_detector/, wait for 2 seconds, check you score, done.",
            llm=llm_manager,
